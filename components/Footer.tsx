...
export default function Footer({ footerNav }: { footerNav: ContentData }) {
  return (
    <div className="flex w-full flex-col space-y-9 border-t border-indigo-500 bg-slate-900 px-6 py-9 md:flex-row md:items-center md:justify-between md:space-y-0 md:px-28">
      <div>
